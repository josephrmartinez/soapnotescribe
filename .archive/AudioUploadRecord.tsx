...
// import { fetchPatientProfileById, fetchUserSettings } fro../app/lib/dataata';
...
//       const fileName = `upload-${self.crypto.randomUUID()}.${extension}`;
//       await uploadFile('audiofiles', fileName, file);
//     } catch (error) {
//       console.error('Error uploading file:', error);
//     }
...
//             />
//           ) : status === 'uploading' ? (
//             <div>file {percentageUploaded}% uploaded</div>
//           ) : (
//             ''
//           )}
//         </div>
