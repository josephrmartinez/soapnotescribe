...
<strong style={{ color: "#DE4A1D" }}>Partner:</strong> so I just got a{" "}
...
<strong style={{ color: "#DE4A1D" }}>Partner:</strong> cursory, like,
...
<strong style={{ color: "#DE4A1D" }}>Partner:</strong> just back up maybe
